...
namespace MetodosNumericos.Tests
{
    public class GaussTests
    {
        ...
        //Ahora para Gauss-Jordan

        [Test]
        public void GaussJordan_Solve_3x3_Works()
        {
            double[,] A = new double[,]
            {
                { 2, -1, 0 },
            ...
            double[] b = new double[] { 1, 0, 1 };
            double[] x = Gauss.ResolverGaussJordan(A, b);
            // Expected solution obtained analytically
            Assert.AreEqual(1.0, x[0], 1e-9);
            Assert.AreEqual(1.0, x[1], 1e-9);
            Assert.AreEqual(1.0, x[2], 1e-9);
        ...
        [Test]
        public void GaussJordan_Solve_4x4_Works()
        {
            double[,] A = new double[,]
            {
                {4, 1, 2, -1},
        ...
        [Test]
        public void GaussJordan_Solve_Pivoting_Required_Works()
        {
            // Se ocupa pivoteo
            double[,] A = new double[,]
            {
